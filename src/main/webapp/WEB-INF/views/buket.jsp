	...
	<section class="r_order">
		<div class="pay_box" style="top: 30px;">
			...
			<ul class="p_list">
				...
				<!--
				<li>
					<span class="name">에그파 하프앤하프</span>
					<span class="t_org">R</span>
					<span class="num">10</span>
					<strong>25,900원</strong>
				</li>
				<li>
					<span class="name">맘마미아</span>
					<span class="t_red">L</span>
...
<script type="text/javascript">
 ...
 window.ne_tgm_q.push(
 {
 	...
 	pageEncoding:'utf-8'
		...
		<!-- //footer -->
	</div><iframe id="ne_tgmiframe_0" width="0" height="0" style="position:absolute;width:0px;height:0px;display:none;" src="about:blank"></iframe><div id="adn_container" style="display:none"></div><iframe id="ne_tgmiframe_1" width="0" height="0" style="position:absolute;width:0px;height:0px;display:none;" src="about:blank"></iframe>
	<!-- //wrap -->
